...
// EXTERNAL MODULE: ../../node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[1].use[1]!./packages/editor/emulator/src/styles/emulator.css
var emulator = __webpack_require__(285);
;// ./packages/editor/emulator/src/styles/emulator.css
...
var update = injectStylesIntoStyleTag_default()(emulator/* default */.A, options);




       /* harmony default export */ const styles_emulator = (emulator/* default */.A && emulator/* default */.A.locals ? emulator/* default */.A.locals : undefined);

;// ./packages/editor/emulator/src/emulator.ts
...
window.define = function define(fn) {
    ...
    fetch('engine.json').then(async (response) => {
        _engineData = await response.json();
    }).then(() => {
        _tabs.forEach((tab) => {
...
//# sourceMappingURL=editor-emulator.js.map